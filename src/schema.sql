...
CREATE TABLE IF NOT EXISTS quote_items(id SERIAL PRIMARY KEY,quote_id INT REFERENCES quotes(id) ON DELETE CASCADE,product_id INT REFERENCES products(id),description TEXT,qty NUMERIC(14,3) NOT NULL,unit_price NUMERIC(14,2) NOT NULL);
